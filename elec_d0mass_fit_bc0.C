...
void elec_d0mass_fit_bc0() {
  ...
  Float_t d0mass,mass,mom,delta,dsmom,dstrf,dz,e1_l,prk1_l,prp1_l,elec_mom,pr_mom,bc0,bc3,pissvd,prsvd,elsvd,pis_k,pis_p ;
  ...
  for(int i=0;i< chain.GetEntries();i++) {
    ...
    if(d0mass>1.8 && d0mass<1.9 && delta>0.144 && delta<0.147 && pissvd>2 && elsvd>2 && prsvd>2 && e1_l>0.9 && prk1_l>0.6 && prp1_l>0.6 && pis_p>0.6 && mom>2.5 && pr_mom>1.7 && elec_mom>0.7 && bc0==100)
  ...
  RooRealVar *sigma_s = new RooRealVar("sigma_s", "Sigma of 1st gaussian",0,0.1);
  ...
  s.SetTextFont(42);
  s.SetTextColor(1);
  s.DrawLatex(0.3,0.5,"#chi^{2}/ndf = 0.97");
