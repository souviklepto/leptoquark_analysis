...
void elec_deltam_fit_bc3() {
  ...
  Float_t d0mass,mass,mom,delta,dsmom,dstrf,dz,e1_l,prk1_l,prp1_l,elec_mom,pr_mom,pissvd,elsvd,prsvd,pis_k,bc2,bc3,pis_p ;
  ...
  for(int i=0;i< chain.GetEntries();i++) {
    ...
    if(d0mass>1.85 && d0mass<1.875 && delta>0.14 && delta<0.152 && pissvd>2 && elsvd>2 && prsvd>2 && e1_l>0.9 && prk1_l>0.6 && prp1_l>0.6 && pis_p>0.6 && mom>2.5 && pr_mom>1.7 && elec_mom>0.7 && bc3==100)
     {deltam->setVal(delta);
  ...
  s.SetTextFont(42);
  s.SetTextColor(1);
  s.DrawLatex(0.3,0.5,"#chi^{2}/ndf = 1.11");
